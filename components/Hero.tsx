    ...
    <section className="relative w-full overflow-hidden bg-zinc-50 flex items-center lg:h-[95vh] py-16 lg:py-0">
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative mt-16 lg:mt-0">
          ...
          {/* Floating Tag */}
          <div className="absolute bottom-4 -left-4 lg:top-1/2 lg:-right-8 lg:-translate-y-1/2 z-20 glass p-6 lg:px-8 lg:py-5 rounded-3xl shadow-xl animate-float">
            <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 mb-2">Trending Now</p>
            <p className="text-2xl lg:text-3xl font-black text-reps-gradient">#RepsNation</p>
          </div>
        </div>
      </div>
    </section>
